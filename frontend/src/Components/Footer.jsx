...
const Footer = () => {
  return (
    <div>
    <div className="relative border-t-gray-300 flex w-full bottom-0 items-center justify-center border-t mt-5">
        <div className="mt-3 flex">
        <span className="opacity-40"> Copyright reserved HungerEats @2024</span>
      <div className=" absolute w-full mb-2  flex right-0 gap-4 justify-end mr-4 opacity-30">
        {/* FacebookIcon */}
        <svg
          focusable="false"
          aria-hidden="true"
          ...
          width="24"
          height="24"
          class="MuiSvgIcon-root MuiSvgIcon-sizeMd css-13gklk0">
          <path
            fill="currentColor"
