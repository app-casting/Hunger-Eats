...
const Footer = () => {
  return (
    <div className="relative border border-t-gray-300 flex w-full bottom-0 items-center justify-center ">
        <div className="mt-3">
      <div className=" absolute w-full mb-2 mt-2 flex right-0 gap-4 justify-end mr-4">
        {/* FacebookIcon */}
        <svg
          focusable="false"
          aria-hidden="true"
      ...
      <span className="opacity-"> Copyright reserved HungerEats @2024</span>
      </div>
    </div>
  );
};
